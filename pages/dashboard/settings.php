...
<div class="max-w-2xl mx-auto flex flex-col gap-6">
    ...
    <div>
        <div class="flex items-center gap-3 mb-2">
            <span class="px-3 py-1 bg-[#a9a4ff]/10 text-[#a9a4ff] text-xs font-black rounded-full tracking-widest uppercase">Settings</span>
        </div>
        <h1 class="text-3xl font-black font-headline text-white">Account Settings</h1>
        <p class="text-slate-400 text-sm mt-1">Manage your personal details and account security.</p>
    </div>
    ...
    <div class="bg-[#181828] rounded-xl border border-white/5 overflow-hidden">
        <div class="px-6 py-4 border-b border-white/5 flex items-center gap-3">
            <div class="w-9 h-9 rounded-full bg-[#a9a4ff]/10 flex items-center justify-center flex-shrink-0">
                <span class="material-symbols-outlined text-[#a9a4ff]" style="font-size:18px">person</span>
            </div>
            <div>
                <h3 class="text-base font-bold text-white font-headline">Personal Profile</h3>
                <p class="text-xs text-slate-500">Your name and email address.</p>
            </div>
        </div>
        <div class="p-6">
            <form method="POST" action="<?= BASE_URL ?>/dashboard/settings" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div class="space-y-1.5">
                        <label for="name" class="text-xs font-bold uppercase tracking-widest text-[#9a94ff]">Full Name</label>
                    ...
                    <div class="space-y-1.5">
                        <label for="email" class="text-xs font-bold uppercase tracking-widest text-[#9a94ff]">Email Address</label>
    ...
    <div class="bg-[#181828] rounded-xl border border-white/5 overflow-hidden">
        <div class="px-6 py-4 border-b border-white/5 flex items-center gap-3">
            <div class="w-9 h-9 rounded-full bg-[#a9a4ff]/10 flex items-center justify-center flex-shrink-0">
                <span class="material-symbols-outlined text-[#a9a4ff]" style="font-size:18px">lock</span>
            </div>
            <div>
                <h3 class="text-base font-bold text-white font-headline">Account Security</h3>
                <p class="text-xs text-slate-500">Change your dashboard password.</p>
            </div>
        </div>
        <div class="p-6">
            <form method="POST" action="<?= BASE_URL ?>/dashboard/settings" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    <label for="current_password" class="text-xs font-bold uppercase tracking-widest text-[#9a94ff]">Current Password</label>
                    <input type="password" name="current_password" id="current_password" required
                           class="w-full bg-[#121220] border-none rounded-xl p-4 text-white placeholder-slate-600 focus:ring-2 focus:ring-[#685ef7]/50 transition-all text-sm">
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div class="space-y-1.5">
                        <label for="new_password" class="text-xs font-bold uppercase tracking-widest text-[#9a94ff]">New Password</label>
                        <input type="password" name="new_password" id="new_password" required minlength="6"
                               class="w-full bg-[#121220] border-none rounded-xl p-4 text-white placeholder-slate-600 focus:ring-2 focus:ring-[#685ef7]/50 transition-all text-sm">
                    </div>
                    <div class="space-y-1.5">
                        <label for="confirm_password" class="text-xs font-bold uppercase tracking-widest text-[#9a94ff]">Confirm New Password</label>
                ...
                <div class="flex justify-end pt-2">
                    <button type="submit"
                            class="px-6 py-2.5 rounded-full bg-[#181828] border border-white/10 hover:bg-white/5 text-white font-bold text-sm transition-all">
                        Change Password
                    </button>
                </div>
            </form>
